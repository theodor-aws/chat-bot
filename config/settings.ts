...
*********
Models that supprot Converse API:
https://docs.aws.amazon.com/bedrock/latest/userguide/conversation-inference-supported-models-features.html



*********
Models that supprot cross-region inference (preffered method Claude 3.5 Sonnnet):
...
*********
All Bedrock Models ID (not cross-region profiles):
